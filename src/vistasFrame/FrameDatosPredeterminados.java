...
public class FrameDatosPredeterminados extends JFrame {
    ...
    public FrameDatosPredeterminados() {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setBounds(100, 100, 384, 465);
        setTitle("DATOS PREDETERMINADOS");
        ...
        JLabel lblTitulo = new JLabel("Datos predeterminados");
        ...
        btnGuardar.setBounds(28, 353, 133, 24);
        panel.add(btnGuardar);

        btnRestablecer = new JButton("Restablecer");
        btnRestablecer.setFont(new Font("Tahoma", Font.PLAIN, 18));
        btnRestablecer.setBounds(197, 353, 133, 24);
