...
public class BotonEliminarRenderer extends JButton implements TableCellRenderer {
    ...
    public BotonEliminarRenderer() {
        ...
        ImageIcon originalBasurero = new ImageIcon(PanelPrincipal.class.getResource("/recursos/basurero.png"));
